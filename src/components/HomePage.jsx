...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section  className="relative min-h-screen overflow-hidden flex items-center bg-[#F8FBF8] py-16 lg:py-0">
        {/* Soft organic background shapes */}
        <div className="absolute -top-32 -left-32 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-[#5B8C5A]/10 rounded-full blur-3xl" />
        <div className="absolute top-1/3 -right-32 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#4A6FA5]/10 rounded-full blur-3xl" />
